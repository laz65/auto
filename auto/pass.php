                    ...
                    <tr>
                      <td align="right">
						<div align="justify" class="text">
                                              ...
                                              <p align="center"><strong>Зміна паролю користувача.</strong>
                                              <p align="left">                                              
<?php



echo "Ви увійшли як $user_auto <br>Ваш логін - $login<br><br>";

		

if($passw = $_POST['pass1'])
	{		
		if($pass == $_POST['pass'])
			{
				if($_POST['pass1'] == $_POST['pass2']) if(!preg_match('/[^a-zA-Z0-9_]/i', $passw))
					{
						echo `sudo -i htpasswd -D /var/www/auto/.htpasswd $login`;
						echo `sudo -i htpasswd -b /var/www/auto/.htpasswd $login $passw`;
						if (pg_query($connection, "update user_auto set pass = '$passw' where login = '$login';")) echo "Пароль змінено.<br>";
						echo "<br><strong>Пароль успішно змінено!</strong>";

					} 
				else echo "<br><strong>Повинні використовуватись тількі латинські символи та цифри!</strong>"; 
				else echo "<br><strong>Паролі не співпадають!</strong>"; 
			}
		else echo "<br><strong>Ви ввели невірний пароль!</strong>";
			
	}
else echo "<br>Якщо ви бажаете змінит свій пароль, треба в полях нижче ввести старий пароль, та новий. Для надійності новий пароль вводиться в 2-х полях. Після цього треба натиснути кнопку 'Змінити пароль'.";
...
?>
											  ...
											  <form name="form1" method="post" action="">
											    <p>
											      <label for="pass">Старий пароль</label>
											    ...
											    <p>
											      <label for="pass2">Новий пароль</label>
											      <input type="password" name="pass2" id="pass2">
											    </p>
											    <p>
											      <input type="submit" name="subm" id="subm" value="Змінити Пароль">
											    </p>
											  </form>
											  <p align="center">                                              
											  <!-- InstanceEndEditable -->
