...
{		
		...
		$history = $db['history'];
		$history = $history . ";<br>" . date( 'H\:i d\-m\-Y', $date_now) . " - " . $pidp .  " підписав документи, зміни виконав " . $user_auto;
		if (pg_query($connection, "UPDATE auto set stan = 'Затверджено, док. підписані', history = '$history' where auto_id = $auto_id ;")) 
echo "<br><strong>Заявку підписано</strong>","<META HTTP-EQUIV=\"Refresh\" content =\"2; URL='index.php'\">"; else echo "<br><strong>Заявку підписати не вдалося</strong>";
...
?>
Відмітка про підпис документів для водія по заявці:
...
Виберіть керівника, який підписав документи:


  
  <select name="pidp" id="pidp">
  <?php
...
?>
    ...
    <p>
      <input type="submit" name="Submit" value="Зробити відмітку про підпис">
    </p>
